...
def hash_160_to_bc_address(h160):
    vh160 = "\x00"+h160  # \x00 is version 0WWW
...
if __name__ == '__main__':
    sample: str = '005cc87f4a3fdfe3a2346b6953267ca867282630d3f9b78e64'\
    x: str = sample.encode().decode('hex_codec')
    encoded: str = b58encode(x)
